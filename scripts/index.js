...
const news = [
  "Livingstone: 'No time for blocks in T20s'",
  "Stephen Fry named MCC President",
  "Australia remain No. 1 Test side",
  "Uncapped Kamil, Kamindu in SL squad",
  "County: Stokes, Root back in action",
  "Buzz: Rinku 'Nostradamus' Singh",
];
...
searchData(
  "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=41da0db4bf1d4251bf434969c4daaa7a",
  "random-news",
  1
);
